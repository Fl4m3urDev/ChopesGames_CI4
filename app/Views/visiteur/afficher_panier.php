                    ...
                    <tr>
                        <td>
                            <?php if (!empty($item['image'])) { ?>
                                <a href="<?php echo base_url() . '/index.php/Visiteur/voir_un_produit/' . $item['id'] ?>"><?php echo img_class($item['image'] . '.jpg', 'image','img_panier')?></a>
                            <?php } else { ?>
                                <a href="<?php echo base_url() . '/index.php/Visiteur/voir_un_produit/' . $item['id'] ?>"><img src="<?php echo base_url() . '/assets/images/nonimage.jpg' ?>" width="80" /></a>
                            <?php } ?>
                        </td>
                        <td><a href="<?php echo base_url() . '/index.php/Visiteur/voir_un_produit/' . $item['id'] ?>"><?php echo $item['name']; ?></a></td>
