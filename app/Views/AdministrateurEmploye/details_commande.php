<div class="row">
                        ...
                        <tr>
                            <td>
                                <?php if (!empty($produit['NOMIMAGE'])) { ?>
                                    <a href="<?php echo base_url() . 'index.php/Visiteur/voir_un_produit/' . $produit['NOPRODUIT'] ?>"><img src="<?php echo base_url() . '/assets/images/' . $produit['NOMIMAGE'] . '.jpg' ?>" width="80" /></a>
                                <?php } else { ?>
                                    <a href="<?php echo base_url() . 'index.php/Visiteur/voir_un_produit/' . $produit['NOPRODUIT'] ?>"><img src="<?php echo base_url() . '/assets/images/nonimage.jpg' ?>" width="80" /></a>
                                <?php } ?>
                            </td>
                            <td><a href="<?php echo base_url() . 'index.php/Visiteur/voir_un_produit/' . $produit['NOPRODUIT'] ?>"><?php echo $produit['LIBELLE']; ?></a></td>
    ...
    <div class="col-md-3">
        ...
        <div class="d-grid gap-2 mt-2">
            <a class="btn hvr-hover bg-success bg-opacity-75" href="<?php echo site_url('AdministrateurEmploye/commande_traitees/'.$commande['NOCOMMANDE']) ?>">Passer la commande à 'Traitée'</a>
        </div>
    </div>
</div>