...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
    <div class='container-fluid'>
        ...
        <div class="col-md-3 col-sm-6">
            <img class="navbar-brand" src="<?php echo base_url() . '/assets/images/logo.jpg' ?>" alt="Logo">
            <a href="<?php echo site_url('Visiteur/flux_rss') ?>">
                <img class="navbar-brand" src="<?php echo base_url() . '/assets/images/rss.png' ?>" width="60">
            </a>
            <BR>
            <p class="text-light">© Adrien Lorin, 2020 - D. Boucard and co</p>
        </div>
        <div class="col-md-3 col-sm-6">
        ...
        <div class="col-md-3 col-sm-6">
            ...
            <p class="text-light">Abonnez vous à noitre lettre d'information pour ne rater aucune nouveauté</p>
